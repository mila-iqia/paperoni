...
@pytest.mark.parametrize(["month", "abbreviation", "number"], [
    ("January", "Jan", 1),
    ("February", "Feb", 2),
    ("March", "Mar", 3),
    ("April", "Apr", 4),
...
@pytest.mark.parametrize(["input_str", "expected_date", "expected_precision"], [
...
def test_extract_date_full_month_day_year_format(input_str, expected_date, expected_precision):
